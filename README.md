...
│       ├── images/                # 이미지 파일들
│       └── documents/             # 문서 파일들
├── ⚡ lambda/                      # AWS Lambda 함수들 (선택사항)
│   ├── contact-handler/           # 연락처 폼 처리
│   └── analytics/                 # 방문자 통계
...
<details>
<summary>⚡ Lambda 함수 구조 보기</summary>

```
lambda/
├── 📧 contact-handler/            # 연락처 폼 처리 Lambda
│   ├── index.js                   # 메인 핸들러
│   ├── package.json               # 의존성
│   └── email-template.html        # 이메일 템플릿
├── 📊 analytics/                  # 방문자 분석 Lambda
│   ├── visitor-tracker.py         # 방문자 추적
│   ├── report-generator.py        # 리포트 생성
│   └── requirements.txt           # Python 패키지
├── 🔍 project-api/                # 프로젝트 데이터 API
│   ├── projects-handler.js        # 프로젝트 정보 반환
│   └── project-data.json          # 프로젝트 데이터
└── 🛠️ utils/                      # 공통 유틸리티
    ├── aws-clients.js             # AWS SDK 클라이언트
    └── response-helper.js         # HTTP 응답 헬퍼
```

</details>

<details>
<summary>🌐 프론트엔드 상세 구조 보기</summary>

```
frontend/
├── 📄 index.html                  # SPA 메인 페이지
├── 🎨 css/                        # 스타일시트
│   ├── common.css                 # 전역 스타일, 변수, 리셋
│   ├── components.css             # 버튼, 카드, 모달 등
│   └── sections.css               # 섹션별 레이아웃
├── 📱 js/                         # JavaScript 모듈
│   ├── main.js                    # 메인 앱 로직
│   ├── projects.js                # 프로젝트 모달 관리
│   ├── animations.js              # 애니메이션 효과
│   └── api.js                     # Lambda API 통신
├── 🖼️ assets/                     # 정적 자원
│   ├── images/                    # 이미지 파일들
│   │   ├── profile/               # 프로필 이미지
│   │   ├── projects/              # 프로젝트 스크린샷
│   │   ├── certificates/          # 자격증 이미지
